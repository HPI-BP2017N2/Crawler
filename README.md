...
``` sh
storm jar target/spikeStormCrawler-1.0-SNAPSHOT.jar de.hpi.demo.CrawlTopology -conf crawler-conf.yaml -local
```
...
``` sh
storm jar target/spikeStormCrawler-1.0-SNAPSHOT.jar  org.apache.storm.flux.Flux --local crawler.flux --sleep 86400000
```
